  ...
  return (
    <div className="grid w-full flex-grow items-center bg-background px-4 sm:justify-center">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="w-full flex flex-col gap-y-4 rounded-2xl px-4 py-10 sm:w-96 sm:px-8"
        >
          ...
          <div className="rounded-xl bg-neutral-100 p-5">
            ...
            <div className="space-y-2">
              <Clerk.Connection
                name="google"
                className="flex h-10 w-full items-center justify-center gap-x-3 rounded-sm bg-gradient-to-b from-white to-neutral-50 px-2 py-1.5 text-sm font-medium text-neutral-950 shadow-sm outline-none ring-1 ring-black/5 hover:to-neutral-100 focus-visible:outline-offset-2 focus-visible:outline-neutral-600 active:text-neutral-950/60"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
