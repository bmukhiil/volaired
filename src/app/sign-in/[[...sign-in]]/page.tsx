...
//   return (
//     <div className="w-screen h-screen border border-border justify-center bg-zinc-100 flex-grow items-center px-4 sm:justify-center">
//       <SignIn.Root>
//         <SignIn.Step
//           name="start"
//           className="shadow-md bg-background w-full flex flex-col gap-y-4 rounded-2xl px-4 py-10 sm:w-96 sm:px-8"
//         >
...
//               Or, sign in with these platforms
//             </p>
//             <div className="space-y-2">
//               <Clerk.Connection
//                 name="google"
//                 className="flex h-10 w-full text-sm font-medium rounded-md items-center justify-center gap-x-3 border border-input bg-background hover:bg-accent hover:text-accent-foreground"
//               >
//                 <svg
//                   xmlns="http://www.w3.org/2000/svg"
//                   fill="none"
...
//             <Link
//               href="/sign-up"
//               className="font-medium hover:underline text-foreground outline-none"
//             >
//               Sign up
//             </Link>
//           </p>
...
//             <Link
//               href="/sign-up"
//               className="rounded px-1 py-0.5 text-foreground outline-none"
//             >
//               Sign up
//             </Link>
//           </p>
